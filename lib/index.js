(function (global, factory) {
  ...
  function combineActions() {
    ...
    return { toString: function toString$$1() {
  ...
  var isPlainObject = (function (value) {
    if ((typeof value === 'undefined' ? 'undefined' : _typeof$1(value)) !== 'object' || value === null) return false;
  ...
  var camelCase$1 = (function (type) {
    return type.indexOf(namespacer) === -1 ? lodash_camelcase(type) : type.split(namespacer).map(function (part) {
      return lodash_camelcase(part);
    }).join(namespacer);
  });
  ...
  function actionMapToActionCreators(actionMap) {
    ...
    return arrayToObject(Object.keys(actionMap), function (partialActionCreators, type) {
      ...
      var actionCreator = isArray(actionMapValue) ? createAction.apply(undefined, [prefixedType].concat(_toConsumableArray$1(actionMapValue))) : createAction(prefixedType, actionMapValue);
  ...
  function actionCreatorsFromIdentityActions(identityActions, options) {
    ...
    return arrayToObject(Object.keys(actionCreators), function (partialActionCreators, type) {
      return _extends({}, partialActionCreators, _defineProperty({}, camelCase$1(type), actionCreators[type]));
    });
  }
  ...
  var createCurriedAction = (function (type, payloadCreator) {
    return lodash_curry(createAction(type, payloadCreator), payloadCreator.length);
  });
  ...
  var reduceReducers = unwrapExports(dist);
  ...
  function handleActions(handlers, defaultState) {
    ...
    var reducer = reduceReducers.apply(undefined, _toConsumableArray$2(reducers));
    return function () {
      var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultState;
      var action = arguments[1];
  ...
  var _reduceReducers2 = _interopRequireDefault(dist);
  ...
  var _reduxActions = ( lib$1 && index ) || lib$1;
  ...
  function createActionThunk(type, fn) {
    ...
    var actionCreators = (_actionCreators = {}, _defineProperty(_actionCreators, TYPE_START, (0, _reduxActions.createAction)(TYPE_START)), _defineProperty(_actionCreators, TYPE_SUCCEEDED, (0, _reduxActions.createAction)(TYPE_SUCCEEDED)), _defineProperty(_actionCreators, TYPE_FAILED, (0, _reduxActions.createAction)(TYPE_FAILED)), _defineProperty(_actionCreators, TYPE_ENDED, (0, _reduxActions.createAction)(TYPE_ENDED)), _actionCreators);
  ...
  var createThunkAction = (function (name, thunkAction, metaCreator) {
    return lib_1$1(name, function (payload, store) {
